...
SELECT emp_no, birth_date, first_name, last_name, geneder, hire_date
FROM employees
...
FROM employees
GROUP BY last_name
ORDER BY frequency DESC;-- Create Employees Table
DROP TABLE IF EXISTS employees;
CREATE TABLE employees
(
	emp_no INT PRIMARY KEY NOT NULL,
...
-- 2. List employees who were hired in 1986.
SELECT * FROM employees
WHERE hire_date = '01/01/1986' and hire_date LIKE  '1986';
